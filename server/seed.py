...
with app.app_context():
    ...
    admin = User(email="admin@mazingira.com", first_name="Jay",last_name="Kimani", password="admin")
    donor = User(email="user@mazingira.com", first_name="Priscilla",last_name="Wakahia", password="user")
    ...
    donation = Donation(amount=230.0, donor_id=1, organization_id=1)
